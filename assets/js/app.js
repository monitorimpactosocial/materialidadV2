...
(function () {
  ...
  // Defaults P, S, B por tema — valores finales 15-abr-2026 (VF)
  // Temas no presentes en la lista usan el máximo (5, 5, 5).
  const DEFAULT_PSB = {
    P01: { p: 3, s: 3, b: 3 }, // Rendición de cuentas sobre los impactos
    P02: { p: 4, s: 3, b: 3 }, // Transparencia en las decisiones
    P03: { p: 4, s: 5, b: 5 }, // Comportamiento ético
    P04: { p: 5, s: 5, b: 5 }, // Responder a los grupos de interés (máx.)
    P05: { p: 5, s: 5, b: 5 }, // Cumplimiento de la ley
    P06: { p: 4, s: 5, b: 5 }, // Respeto de los derechos humanos
    P07: { p: 5, s: 5, b: 5 }, // Participación inclusiva (máx.)
    P08: { p: 4, s: 5, b: 5 }, // Protección derechos fundamentales trabajo
    P09: { p: 4, s: 5, b: 5 }, // Altos estándares laborales
    P10: { p: 4, s: 5, b: 5 }, // Salud y seguridad en el trabajo
    P11: { p: 5, s: 5, b: 5 }, // Desarrollo humano y capacitación (máx.)
    P12: { p: 4, s: 5, b: 5 }, // Prevención de la contaminación
    P13: { p: 3, s: 5, b: 5 }, // Uso sostenible de los recursos
    P14: { p: 5, s: 5, b: 5 }, // Acciones frente al cambio climático (máx.)
    P15: { p: 4, s: 5, b: 5 }, // Protección y restauración de ecosistemas
    ...
    P20: { p: 4, s: 3, b: 4 }, // Impulso a proyectos productivos
    P21: { p: 2, s: 3, b: 4 }, // Fomento de la creación de empleo local
  ...
  const DEFAULT_ECF = {
    ...
    P20: { e: 4, c: 2, f: 2 }, // Impulso a proyectos productivos
    P21: { e: 4, c: 2, f: 2 }, // Fomento de la creación de empleo local
    P22: { e: 4, c: 4, f: 4 }, // Acciones para mejorar la salud comunidades (máx.)
    P23: { e: 3, c: 2, f: 2 }, // Inversión en infraestructura básica
